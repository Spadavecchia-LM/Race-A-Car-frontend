...
import {Modal, ModalContent,ModalBody, ModalFooter, useDisclosure,Chip} from "@nextui-org/react";
...
const PublicacionDetal = ({publicacion}) => {
  ...
  const {id,marca, modelo, anio,color, valor, capacidad,traccion, categoria,combustion, caballosDeFuerza, tipoDeCaja, images} = publicacion

  const navigate = useNavigate()

  return (
    <>
            <h1  className='text-primaryWhite text-[24px] sm:text[40px] md:text-[50px] text-center my-10'>{marca} {modelo} {anio}</h1>
  ...
  <div className='grid grid-cols-1 grid-rows-1 gap-3 md:grid-cols-2 md:max-h-[75vh] w-[90%] mx-auto'>
    ...
    <div className="flex flex-col items-center w-full mt-10">
            ...
            <div className="text-primaryWhite grid grid-cols-1 sm:grid-cols-2 gap-10 sm:gap-1 place-items-start md:place-items-center ">
              <div className="list-disc list-inside flex flex-col justify-start items-start">
                <ul className="list-disc list-inside">
                  <li className='text-[14px]  md:text-[18px]'>Techo solar panorámico <Chip className='ml-5'>incluido</Chip></li>
                  <li className="mt-10 text-[14px]  md:text-[18px]">Cámara de retroceso <Chip className='ml-5'>incluido</Chip></li>
                  <li className="mt-10 text-[14px]  md:text-[18px]">Sistema de frenos ABS <Chip className='ml-5'>incluido</Chip></li>
                </ul>
              </div>
              <div className="list-disc list-inside flex flex-col justify-start items-start">
                <ul className="list-disc list-inside">
                  <li className='text-[14px] md:text-[18px]'>Llantas de aleación <Chip className='ml-5'>opcional</Chip></li>
                  <li className="mt-10 text-[14px]  md:text-[18px]">Asientos calefaccionados <Chip className='ml-5'>opcional</Chip></li>
                  <li className="mt-10 text-[14px]  md:text-[18px]">Sistema de navegación GPS <Chip className='ml-5'>opcional</Chip></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <Button className='bg-primaryBlue my-5 mx-auto text-primaryWhite w-[80%] sm:w-[90%] text-[18px] px-[24px] py-[12px]' size='lg' radius='lg' onClick={() => handleScroll()} >Seguir viendo</Button>
      <Button className='bg-primaryGold my-5 mx-auto text-primaryWhite w-[80%] sm:w-[90%] text-[18px] px-[24px] py-[12px]' size='lg' radius='lg' >Proceder con el pago</Button>
