...
const SearchBox = () => {
 ...
 <form className='flex gap-10 items-center justify-center flex-wrap'>
      <div className='flex flex-col gap-2'>
        ...
        <Input size={'sm'}  startContent={<BsGeoAlt />}  className='bg-transparent min-w-[260px]' type="text" id='lugarRecogida' name='lugarRecogida' placeholder='Busca un lugar' />
      </div>
      <div className='flex flex-col gap-2'>
        <label htmlFor="fechaRecogida">Fecha de recogida</label>
        <Input size={'sm'} type="date" name='fechaRecogida' className='bg-transparent min-w-[260px]' id='fechaRecogida'/>
      </div>
      <div className='flex flex-col gap-2'>
        <label htmlFor="lugarEntrega">Lugar de entrega</label>
        <Input size={'sm'} startContent={<BsGeoAlt />} className='bg-transparent min-w-[260px]' placeholder='Busca un lugar' type="text" name='lugarEntrega' id='lugarEntrega'  />
      </div>
      <div className='flex flex-col gap-2'>
        <label htmlFor="fechaEntrega">Fecha de entrega</label>
        <Input size={'sm'}  type="date" name='fechaEntrega' className='bg-transparent min-w-[260px]' id='fechaEntrega'/>
      </div>
